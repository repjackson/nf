...
if Meteor.isClient
    ...
    Template.questions.onCreated ->
        @autorun -> Meteor.subscribe 'question_facets',
        ...
        @autorun => @subscribe 'question_total',
            Session.get('product_search')
            picked_products.array()
            Session.get('picked_month')
            Session.get('picked_weeknum')
    ...
    Template.questions.helpers 
        ...
        question_total: -> Counts.get('question_total')        
        current_search: ->
            Session.get('product_search')
    ...
    Template.questions.events
        ...
        'change .import': (e,t)->
            papa.parse(e.target.files[0], {
                ...
                complete: (results)->
                    console.log results
                    Meteor.call 'parse_question', results, ->
...
if Meteor.isServer 
    ...
    Meteor.publish 'question_total', (
        ...
        Counts.publish this, 'question_total', Docs.find(match)
        return undefined
